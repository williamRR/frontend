...
export const EventCard = ({ event }) => {
  ...
  return (
    <>
      <div onClick={() => navigate(`/event-overview/${event.id}`)} className='group w-full lg:w-1/2 xl:w-1/3 px-2 lg:px-2'>
        <div className='w-full bg-white border shadow-md rounded-lg dark:border-0 dark:bg-gray-800 dark:border-gray-700'>
          <div className='w-full relative rounded-lg overflow-hidden'>
            ...
            <div className='px-5 pb-5'>
              ...
              <div className='flex items-center justify-between'>{/* <div className='text-gray-700 dark:text-gray-200 text-xl sm:text-lg'>20 de Septiembre 2024</div> */}</div>
            </div>
          </div>
        </div>
      </div>
